...
describe('total likes', () => {
  ...
  test('when list has many blogs, total caculated correctly', () => {
...
describe('favorite blog', () => {
  ...
  test('when list has only one blog, blog is returned', () => {
    const result = listHelper.favoriteBlog(listWithOneBlog)
    assert.deepStrictEqual(result, listWithOneBlog[0]
    )
  })
  test('when list has many blogs, correct blog returned', () => {
